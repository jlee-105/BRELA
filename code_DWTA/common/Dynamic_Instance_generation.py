...
def _create_no_action_encoding(batch_size, max_time, **kwargs):
...
def _generate_training_instances(batch_size, max_time, num_weapons, num_targets, TW=None, **kwargs):
    """
    ...
    from .Dynamic_HYPER_PARAMETER import NUM_WEAPONS, NUM_TARGETS, MIN_TARGET_VALUE, MAX_TARGET_VALUE, AMM, MAX_TIME as GLOBAL_MAX_TIME, NUM_FEATURES
...
def _generate_evaluation_instances(value, prob, TW, max_time, amm=None, **kwargs):
    ...
    from .Dynamic_HYPER_PARAMETER import NUM_FEATURES
